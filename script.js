    ...
    var estado = document.getElementById('selectEstado');
        ...
        const IDH = new Chart(ctx2, {
            ...
            data: {
                    ...
                    datasets: [{
                        label: 'IDH',
                        data: [0.751, 0.677, 0.780, 0.780, 0.742, 0.723, 0.874, 0.802, 0.800, 0.683, 0.800, 0.802, 0.755, 0.718, 0.718, 0.703, 0.802, 0.832, 0.738, 0.756, 0.750, 0.832, 0.840, 0.833, 0.742, 0.756, 0.699],
                        borderColor: [
                            'rgba(0, 0, 0)'
                        ],
                        borderWidth: 1
